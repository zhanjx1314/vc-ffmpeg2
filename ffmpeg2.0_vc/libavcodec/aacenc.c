...
static const AVOption aacenc_options[] = {
    ...
    {"aac_coder", "", offsetof(AACEncContext, options.aac_coder), AV_OPT_TYPE_INT, { 2}, 0, AAC_CODER_NB-1, AACENC_FLAGS},
    {NULL}
};
...
const enum AVSampleFormat aac_sample_fmts[] = { AV_SAMPLE_FMT_FLTP,AV_SAMPLE_FMT_NONE };
