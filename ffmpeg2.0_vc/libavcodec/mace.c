...
const enum AVSampleFormat mace3_sample_fmts[] = { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_NONE };
...
const enum AVSampleFormat mace6_sample_fmts[] = { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_NONE };
