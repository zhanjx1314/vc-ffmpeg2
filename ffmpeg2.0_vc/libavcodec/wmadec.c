...
const enum AVSampleFormat sample_dec_fmts_wmav1[] = { AV_SAMPLE_FMT_FLTP,AV_SAMPLE_FMT_NONE };
...
AVCodec ff_wmav1_decoder = {
	...
	/* sample_fmts = */ sample_dec_fmts_wmav1,
	/* channel_layouts = */0,
	/* max_lowres = */ 0,
	/* priv_class = */ 0,
	/* profiles = */ 0,
...
const enum AVSampleFormat sample_dec_fmts_wmav2[] = { AV_SAMPLE_FMT_FLTP,AV_SAMPLE_FMT_NONE };
...
AVCodec ff_wmav2_decoder = {
	...
	/* pix_fmts = */ 0,
	/* supported_samplerates = */ 0,
	/* sample_fmts = */ sample_dec_fmts_wmav2,
	/* channel_layouts = */0,
	/* max_lowres = */ 0,
	/* priv_class = */ 0,
	/* profiles = */ 0,
