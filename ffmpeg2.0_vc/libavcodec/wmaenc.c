...
const enum AVSampleFormat sample_fmts_wmav1[] = {AV_SAMPLE_FMT_FLTP,AV_SAMPLE_FMT_NONE };
...
const enum AVSampleFormat sample_fmts_wmav2[] = {AV_SAMPLE_FMT_FLTP, AV_SAMPLE_FMT_NONE };
