...
static av_cold int g726_encode_init(AVCodecContext *avctx)
{
	...
	{
		int aframe_size[] = { 4096, 2736, 2048, 1640 };
		avctx->frame_size = aframe_size[c->code_size - 2];
	}
    return 0;
}
...
const enum AVSampleFormat g726_sample_fmts[] ={ AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
