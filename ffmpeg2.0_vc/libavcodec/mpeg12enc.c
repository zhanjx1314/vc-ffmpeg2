...
#define COMMON_OPTS\
    { "gop_timecode",        "MPEG GOP Timecode in hh:mm:ss[:;.]ff format", OFFSET(tc_opt_str), AV_OPT_TYPE_STRING, {NULL}, CHAR_MIN, CHAR_MAX, VE },\
...
const enum AVPixelFormat mpeg1video_pix_fmts[] = { AV_PIX_FMT_YUV420P,AV_PIX_FMT_NONE };
...
const enum AVPixelFormat mpeg2video_pix_fmts[] = {AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE};
