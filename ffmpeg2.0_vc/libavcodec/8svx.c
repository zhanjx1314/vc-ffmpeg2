...
const enum AVSampleFormat eightsvx_sample_fmts[] = { AV_SAMPLE_FMT_U8P,AV_SAMPLE_FMT_NONE };
AVCodec ff_eightsvx_fib_decoder={
	...
	/*.sample_fmts=*/eightsvx_sample_fmts,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
...
const enum AVSampleFormat eightsvx_exp_sample_fmts[] = { AV_SAMPLE_FMT_U8P,AV_SAMPLE_FMT_NONE };
AVCodec ff_eightsvx_exp_decoder={
	...
	/*.pix_fmts=*/0,
	/*.supported_samplerates=*/0,
	/*.sample_fmts=*/eightsvx_exp_sample_fmts,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
