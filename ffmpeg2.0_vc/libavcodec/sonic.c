...
const enum AVSampleFormat sonic_pix_fmts[] = { AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
...
const enum AVSampleFormat sonic_ls_pix_fmts[] = { AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
