...
const enum AVSampleFormat mp1_sample_fmts[] = { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
...
const enum AVSampleFormat mp2_dec_sample_fmts[] ={ AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
AVCodec ff_mp2_decoder={
	...
	/*.pix_fmts=*/0,
	/*.supported_samplerates=*/0,
	/*.sample_fmts=*/mp2_dec_sample_fmts,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
...
const enum AVSampleFormat mp3_sample_fmts[] = { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
...
const enum AVSampleFormat mp3adu_sample_fmts[] = { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
AVCodec ff_mp3adu_decoder={
	...
	/*.pix_fmts=*/0,
	/*.supported_samplerates=*/0,
	/*.sample_fmts=*/mp3adu_sample_fmts,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
...
const enum AVSampleFormat mp3on4_sample_fmts[]= { AV_SAMPLE_FMT_S16P,AV_SAMPLE_FMT_NONE };
AVCodec ff_mp3on4_decoder={
	...
	/*.pix_fmts=*/0,
	/*.supported_samplerates=*/0,
	/*.sample_fmts=*/mp3on4_sample_fmts,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
