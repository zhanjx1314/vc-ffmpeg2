...
#if CONFIG_ASF_MUXER
const AVCodecTag * const asf_codec_tag[] = {codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0};
...
const AVCodecTag * const asf_stream_codec_tag[] = {        codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0};
AVOutputFormat ff_asf_stream_muxer={
	...
	/*.subtitle_codec=*/0,
	/*.flags=*/AVFMT_GLOBALHEADER,
	/*.codec_tag=*/asf_stream_codec_tag,
	/*.priv_class=*/0,
	/*.next=*/0,
	/*.priv_data_size=*/sizeof(ASFContext),
