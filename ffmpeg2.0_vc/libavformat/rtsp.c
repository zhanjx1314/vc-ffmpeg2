...
#define RTSP_REORDERING_OPTS() \
    { "reorder_queue_size", "Number of packets to buffer for handling of reordered packets", OFFSET(reordering_queue_size), AV_OPT_TYPE_INT, { -1 }, -1, INT_MAX, DEC }
...
const AVOption ff_rtsp_options[] = {
    ...
    { "stimeout", "timeout (in micro seconds) of socket i/o operations.", OFFSET(stimeout), AV_OPT_TYPE_INT, { 0}, INT_MIN, INT_MAX, DEC },
...
static const AVOption sdp_options[] = {
    ...
    { "custom_io", "Use custom IO", 0, AV_OPT_TYPE_CONST, { RTSP_FLAG_CUSTOM_IO}, 0, 0, DEC, "rtsp_flags" },
    RTSP_MEDIATYPE_OPTS("allowed_media_types", "Media types to accept from the server"),
    RTSP_REORDERING_OPTS(),
    { NULL },
};
