...
static ebml_master start_ebml_master(AVIOContext *pb, unsigned int elementid, uint64_t expectedsize)
{
	...
	{
	 ebml_master ebml ={ avio_tell(pb), bytes };
    return ebml;
	}
}
...
static const AVOption options[] = {
    { "reserve_index_space", "Reserve a given amount of space (in bytes) at the beginning "
        "of the file for the index (cues).", OFFSET(reserve_cues_space), AV_OPT_TYPE_INT, { 0 }, 0, INT_MAX, FLAGS },
    { NULL },
};
...
const AVCodecTag* const matroska_codec_tag[] = {ff_codec_bmp_tags, ff_codec_wav_tags,         additional_audio_tags, additional_video_tags, 0};
...
const AVCodecTag* const matroska_codec_tag11[] = {ff_codec_wav_tags, additional_audio_tags, 0};
AVOutputFormat ff_matroska_audio_muxer={
	...
	/*.codec_tag=*/matroska_codec_tag11,
