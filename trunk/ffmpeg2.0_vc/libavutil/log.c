...
//static const uint32_t colorxxx[16 + AV_CLASS_CATEGORY_NB] = {
...
static uint32_t color[16 + AV_CLASS_CATEGORY_NB];
static void init_color()
{
	...
	{
		init_color = 1;
		color[AV_LOG_PANIC  /8] =  52 << 16 | 196 << 8 | 0x41;
		color[AV_LOG_FATAL  /8] = 208 <<  8 | 0x41;
		color[AV_LOG_ERROR  /8] = 196 <<  8 | 0x11;
		color[AV_LOG_WARNING/8] = 226 <<  8 | 0x03;
		color[AV_LOG_INFO   /8] = 253 <<  8 | 0x09;
		color[AV_LOG_VERBOSE/8] =  40 <<  8 | 0x02;
		color[AV_LOG_DEBUG  /8] =  34 <<  8 | 0x02;
		color[16+AV_CLASS_CATEGORY_NA              ] = 250 << 8 | 0x09;
		color[16+AV_CLASS_CATEGORY_INPUT           ] = 219 << 8 | 0x15;
		color[16+AV_CLASS_CATEGORY_OUTPUT          ] = 201 << 8 | 0x05;
		color[16+AV_CLASS_CATEGORY_MUXER           ] = 213 << 8 | 0x15;
		color[16+AV_CLASS_CATEGORY_DEMUXER         ] = 207 << 8 | 0x05;
		color[16+AV_CLASS_CATEGORY_ENCODER         ] =  51 << 8 | 0x16;
		color[16+AV_CLASS_CATEGORY_DECODER         ] =  39 << 8 | 0x06;
		color[16+AV_CLASS_CATEGORY_FILTER          ] = 155 << 8 | 0x12;
		color[16+AV_CLASS_CATEGORY_BITSTREAM_FILTER] = 192 << 8 | 0x14;
		color[16+AV_CLASS_CATEGORY_SWSCALER        ] = 153 << 8 | 0x14;
		color[16+AV_CLASS_CATEGORY_SWRESAMPLER     ] = 147 << 8 | 0x14;
	}
}
