...
{"buffer_size", "Socket buffer size in bytes", OFFSET(buffer_size), AV_OPT_TYPE_INT, { 0}, 0, INT_MAX, D|E },
{"localport", "Set local port to bind to", OFFSET(local_port), AV_OPT_TYPE_INT, { 0}, 0, INT_MAX, D|E },
{"localaddr", "Choose local IP address", OFFSET(local_addr), AV_OPT_TYPE_STRING, { ""}, 0, 0, D|E },
...
{"connect", "Should connect() be called on socket", OFFSET(is_connected), AV_OPT_TYPE_INT, { 0}, 0, 1, D|E },
...
{"timeout", "In read mode: if no data arrived in more than this time interval, raise error", OFFSET(timeout), AV_OPT_TYPE_INT, { 0}, 0, INT_MAX, D },
{NULL}
};
