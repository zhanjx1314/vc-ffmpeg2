...
static const AVOption options[] = {
    { "write_id3v2", "Enable ID3 tags writing.",
      OFFSET(write_id3v2), AV_OPT_TYPE_INT, {0}, 0, 1, ENC },
    { "id3v2_version", "Select ID3v2 version to write. Currently 3 and 4 are supported.",
      OFFSET(id3v2_version), AV_OPT_TYPE_INT, { 4}, 3, 4, ENC },
    { NULL },
};
...
const AVCodecTag* const aiff_codec_tag1[] = { ff_codec_aiff_tags, 0 };
