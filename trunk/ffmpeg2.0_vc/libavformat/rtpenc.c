...
static const AVOption options[] = {
    ...
    { "cname", "CNAME to include in RTCP SR packets", offsetof(RTPMuxContext, cname), AV_OPT_TYPE_STRING, {  NULL }, 0, 0, AV_OPT_FLAG_ENCODING_PARAM },
    { "seq", "Starting sequence number", offsetof(RTPMuxContext, seq), AV_OPT_TYPE_INT, {  -1 }, -1, 65535, AV_OPT_FLAG_ENCODING_PARAM },
    { NULL },
};
