    ...
    if (codec && codec->pix_fmts) {
        ...
        if (st->codec->strict_std_compliance <= FF_COMPLIANCE_UNOFFICIAL) {
            if (st->codec->codec_id == AV_CODEC_ID_MJPEG) {
              const enum AVPixelFormat a_pix_fmts[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE };  
				p = a_pix_fmts;
				 
            } else if (st->codec->codec_id == AV_CODEC_ID_LJPEG) {
				const enum AVPixelFormat b_pix_fmts[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUVJ444P, AV_PIX_FMT_YUV420P,
    ...
    if (ost->st->codec->pix_fmt != AV_PIX_FMT_NONE) {
        ...
        if (ost->st->codec->strict_std_compliance <= FF_COMPLIANCE_UNOFFICIAL) {
            if (ost->st->codec->codec_id == AV_CODEC_ID_MJPEG) {
				  const enum AVPixelFormat c_pix_fmts[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUV420P, AV_PIX_FMT_YUV422P, AV_PIX_FMT_NONE };
                p = c_pix_fmts;
            } else if (ost->st->codec->codec_id == AV_CODEC_ID_LJPEG) {
				 const enum AVPixelFormat d_pix_fmts[] = { AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUVJ444P, AV_PIX_FMT_YUV420P,
					AV_PIX_FMT_YUV422P, AV_PIX_FMT_YUV444P, AV_PIX_FMT_BGRA, AV_PIX_FMT_NONE };
                p = d_pix_fmts;
            }
        }
