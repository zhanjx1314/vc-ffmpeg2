                         ...
                         float *out_data)
{
	...
	{
	const float zero_coffes[2] = {-1.99997   , 1.000000000};
	const float pole_coffes[2] = {-1.93307352, 0.935891986};
    ff_acelp_apply_order_2_transfer_function(out_data, synth, zero_coffes, pole_coffes, 0.939805806,
		ctx->highpass_filt_mem, frame_size);
	}
}
