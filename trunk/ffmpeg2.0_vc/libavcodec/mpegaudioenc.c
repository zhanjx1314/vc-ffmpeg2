...
const int mp2_supported_samplerates[] ={44100, 48000,  32000, 22050, 24000, 16000, 0    };
const enum AVSampleFormat mp2_sample_fmts[] ={ AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE };
const uint64_t mp2_channel_layouts[] = { AV_CH_LAYOUT_MONO,AV_CH_LAYOUT_STEREO,0 };
AVCodec ff_mp2_encoder={
	...
	/*.pix_fmts=*/0,
	/*.supported_samplerates=*/mp2_supported_samplerates,
	/*.sample_fmts=*/mp2_sample_fmts,
	/*.channel_layouts=*/mp2_channel_layouts,
	/*.max_lowres=*/0,
	/*.priv_class=*/0,
	/*.profiles=*/0,
