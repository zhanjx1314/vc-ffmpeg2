...
const enum AVPixelFormat mjpeg_pix_fmts[] = {AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_YUVJ444P, AV_PIX_FMT_NONE};
...
AVCodec ff_amv_encoder={
	...
	/*.capabilities=*/0,
	/*.supported_framerates=*/0,
	/*.pix_fmts=*/(const enum AVPixelFormat[]){        AV_PIX_FMT_YUVJ420P, AV_PIX_FMT_YUVJ422P, AV_PIX_FMT_NONE    },
	/*.supported_samplerates=*/0,
	/*.sample_fmts=*/0,
	/*.channel_layouts=*/0,
	/*.max_lowres=*/0,
